...
ros_makedepends=(ros-noetic-trajectory-msgs
...
ros_depends=(ros-noetic-trajectory-msgs
  ros-noetic-realtime-tools
  ros-noetic-urdf
  ros-noetic-roscpp
  ros-noetic-control-toolbox
...
source=("ros_controllers-${pkgver}.tar.gz"::"https://github.com/ros-controls/ros_controllers/archive/${pkgver}.tar.gz")
...
build() {
  ...
  # Build project
  cmake ${srcdir}/ros_controllers-${pkgver}/joint_trajectory_controller \
